import pyttsx3 # type: ignore #convierte el texto en voz
import speech_recognition as sr  # type: ignore #reconocimiento de voz
import pywhatkit # type: ignore #envia mensajes a whatsap
import yfinance as yf # type: ignore #precio de la volsa de valores
import webbrowser #ir a ciertos navegadores
import datetime 
import wikipedia # type: ignore 
import pyjokes # type: ignore #cuenta chistes informaticos jaja

#Opciones de voz / idioma
id1 = r'HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Speech\Voices\Tokens\TTS_MS_ES-MX_SABINA_11.0'

""" Obtener las diferentes voces
def hablar(mensaje):
